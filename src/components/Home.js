...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  //5 days forecast
  const fiveDaysForecast = (city_key, city_name) => {
    setCurrent_key(city_key);
            ...
            <ListGroup.Item key={i}>
              <span
                onClick={() => {
                  ...
                  fiveDaysForecast(city.Key, city.LocalizedName);
                }}
              >
                {city.LocalizedName}
              </span>
          ...
          return (
            <div key={day.Date}>
              ...
              <p id="temp_p">
                <span >min-max</span>
                <br/>
                {Math.round(parseInt((day.Temperature.Minimum["Value"]-32) / 1.8))}-
                {Math.round(parseInt((day.Temperature.Maximum["Value"]-32) / 1.8))}
